    ...
    >
      ...
      <div class="px-5 py-5 border-b border-slate-100/80 dark:border-slate-800/60 flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="w-9 h-9 bg-blue-600 rounded-xl flex items-center justify-center text-white text-lg font-bold shadow-[0_2px_8px_0_rgba(37,99,235,0.35)] shrink-0">
            友
          </div>
          <div>
            <h1 class="text-slate-900 dark:text-white font-semibold tracking-tight text-sm leading-tight">友仁起重行</h1>
            <p class="text-blue-500 dark:text-blue-400 text-xs font-medium tracking-wider mt-0.5">帳務管理系統</p>
          </div>
        </div>
        <!-- 手機關閉按鈕 -->
        <button
